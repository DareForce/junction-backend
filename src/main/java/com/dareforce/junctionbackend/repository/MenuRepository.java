...
public interface MenuRepository extends JpaRepository<Menu, Long> {
    @Query("select m from Menu m join fetch m.restaurant left join fetch m.menuIngreds as mi left join fetch mi.ingredient where m.restaurant.id = :restaurantId")
